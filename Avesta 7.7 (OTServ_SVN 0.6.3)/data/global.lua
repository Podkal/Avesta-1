-- Load Functions and Systems
dofile(getDataDir() .. "server_systems/functions.lua")
dofile(getDataDir() .. "server_systems/vip_system.lua")
dofile(getDataDir() .. "server_systems/bank_system.lua")
dofile(getDataDir() .. "server_systems/bless_system.lua")
